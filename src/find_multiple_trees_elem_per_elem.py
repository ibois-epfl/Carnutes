...
def main():
    ...
    element_geometry, element_guid = interact_with_rhino.select_single_element_to_replace()
    ...
    reference_pc = packing_manipulations.crop_pointcloud(reference_pc, target.geometry.GetBoundingBox(False))
    ...
    adapted_pc = packing_manipulations.crop_pointcloud(adapted_pc, target.geometry.GetBoundingBox(False))
